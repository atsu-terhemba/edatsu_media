...
<head>
    ...
    <title>Server Error - Edatsu Media</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn {
            ...
            padding: 12px 28px; border-radius: 9999px; background: #f97316;
...
<body>
    <div class="container">
        ...
        <p>We're experiencing a server issue. Our team has been notified. Please try again in a moment.</p>
        <a href="/" class="btn">
