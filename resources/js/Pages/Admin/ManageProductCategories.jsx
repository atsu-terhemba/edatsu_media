...
export default function ManageProductCategories({ categories, edit }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const url = editingCategory ? `/edit-product-category/${editingCategory.id}` : '/admin-store-product-category';
            ...
            if (data.success) {
                ...
                router.visit(route('admin.product_categories'), { preserveState: false });
            } else {
    ...
    const handleDelete = async (categoryId) => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.post('/delete-product-category', {
                id: categoryId
            });
                                            ...
                                            {categories.length > 0 ? (
                                                ...
                                                <tr>
                                                    <td colSpan="7" className="text-center text-muted py-4">
                                                        No product categories found. Create your first category!
                                                    </td>
                                                </tr>
                                            )}
                                        </tbody>
