...
const Opportunities = () => {
    ...
    },[rootURL, filter_data, search_keyword]); // Removed setIsLoading, setData, setPagination from dependencies as they're not needed
  ...
  id="searchBar">
                    ...
                    <Col sm={6} xs={12}>
                        ...
                        {/* Add ref to the container that needs to be scrolled to */}
                        <div className='my-3' ref={paginationContainerRef}>
