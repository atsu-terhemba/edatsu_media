...
Route::post('/subscribe', [SubscriptionController::class, 'mail_subscription']);
...
Route::middleware(['auth'])->group(function(){
    ...
    Route::post('/process-subscription', [SubscriberController::class, 'processSubscription'])->name('subscription.process');
    Route::post('/bookmark-feed', [SubscriberController::class, 'bookmarkFeed']);
    Route::post('/bookmark', [App::class, 'bookmark']);
