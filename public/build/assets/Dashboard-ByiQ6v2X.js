import{r as k,j as e,M as R}from"./app-B0kK_MjX.js";import{A as I}from"./AuthenticatedLayout-xHct_SYZ.js";import T from"./SideNav-DFViUw9n.js";import{C,B as _}from"./Header-BcOR5utP.js";import{R as w}from"./Row-B_Sl1fiy.js";import{C as d}from"./Col-Cvyx1Jfn.js";import{U as S,A as q}from"./users-DuxJlw3Y.js";import{c as M}from"./createLucideIcon-DbJAnloH.js";import{C as r}from"./Card-D4qNlYef.js";import{u as E,c as B}from"./ThemeProvider-CD7An8sD.js";import{m as $}from"./ElementChildren-B025F0Nv.js";import{T as D}from"./trending-up-BpKkatF2.js";import"./ListGroup-4CP7A5Fy.js";import"./warning-BMu2thM5.js";import"./Nav-DTyqkuPs.js";import"./useMergedRefs-C3_TMkJy.js";import"./Button-6iYi6Awa.js";import"./sweetalert2.esm.all-B0Dix5B2.js";import"./AbstractModalHeader-Cl2PuRe6.js";import"./index-DkriVCHp.js";import"./Button-DJin0BeK.js";const U=1e3;function H(c,i,a){const t=(c-i)/(a-i)*100;return Math.round(t*U)/U}function A({min:c,now:i,max:a,label:t,visuallyHidden:N,striped:p,animated:u,className:g,style:b,variant:j,bsPrefix:n,...m},o){return e.jsx("div",{ref:o,...m,role:"progressbar",className:B(g,`${n}-bar`,{[`bg-${j}`]:j,[`${n}-bar-animated`]:u,[`${n}-bar-striped`]:u||p}),style:{width:`${H(i,c,a)}%`,...b},"aria-valuenow":i,"aria-valuemin":c,"aria-valuemax":a,children:N?e.jsx("span",{className:"visually-hidden",children:t}):t})}const P=k.forwardRef(({isChild:c=!1,...i},a)=>{const t={min:0,max:100,animated:!1,visuallyHidden:!1,striped:!1,...i};if(t.bsPrefix=E(t.bsPrefix,"progress"),c)return A(t,a);const{min:N,now:p,max:u,label:g,visuallyHidden:b,striped:j,animated:n,bsPrefix:m,variant:o,className:s,children:h,...x}=t;return e.jsx("div",{ref:a,...x,className:B(s,m),children:h?$(h,l=>k.cloneElement(l,{isChild:!0})):A({min:N,now:p,max:u,label:g,visuallyHidden:b,striped:j,animated:n,bsPrefix:m,variant:o},a)})});P.displayName="ProgressBar";/**
