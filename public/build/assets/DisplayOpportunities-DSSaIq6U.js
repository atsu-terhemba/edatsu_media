import{r as d,j as o}from"./app-DJzlAy_2.js";import{S as w}from"./sweetalert2.esm.all-B0Dix5B2.js";import{I as z,p as u,b as C,t as I,c as S}from"./Header-BY_am_eV.js";import"./AbstractModalHeader-B27Xt1a2.js";import"./index-B7qug9rS.js";const R=({data:a,isAuthenticated:m})=>{const[T,c]=d.useState({}),f="/img/logo/main_2.png",x=()=>{w.fire({title:"",html:`
        ...
        `,showConfirmButton:!1,showCloseButton:!0,width:"420px",padding:"0",background:"white",customClass:{popup:"auth-modal-popup",closeButton:"auth-modal-close"}})},h=e=>{if(!m){e.preventDefault(),x();return}S(e.currentTarget)},g=e=>{e.target.src=f};d.useEffect(()=>{c({})},[a]),d.useEffect(()=>{let e,r;const i=()=>{e&&e.disconnect(),e=new IntersectionObserver(t=>{t.forEach(p=>{if(p.isIntersecting){const s=p.target,l=s.dataset.src;l&&(s.src.includes("data:image")||s.src.includes("R0lGODlh"))&&(s.src=l,s.onload=()=>{s.classList.remove("lazy-load");const k=s.dataset.id;c(j=>({...j,[k]:!0}))},s.onerror=g),e.unobserve(s)}})},{rootMargin:"200px"}),document.querySelectorAll(".lazy-load").forEach(t=>{!t.src.includes("data:image")&&!t.src.includes("R0lGODlh")&&(t.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"),e.observe(t)})};return r=setTimeout(()=>{i()},100),()=>{r&&clearTimeout(r),e&&e.disconnect()}},[a]);const y=e=>e&&typeof e=="string"&&e.trim()!=="";function b(e){return!e||typeof e!="string"?"":e.split(",").map((i,n)=>{let s=i.trim().split(/[\s_-]+/).map(l=>l.charAt(0).toUpperCase()+l.slice(1).toLowerCase()).join(" ");return o.jsx("span",{style:{display:"inline-block",padding:"2px 10px",borderRadius:"9999px",background:"#f5f5f7",fontSize:"11px",fontWeight:500,color:"#86868b",marginRight:"4px",marginBottom:"4px"},children:s},n)})}const A=(e,r=150)=>{const i=document.createElement("div");i.innerHTML=e;const n=i.textContent||i.innerText||"";return n.length>r?n.slice(0,r).trim()+"...":n},v=d.useCallback(e=>()=>{c(r=>({...r,[e]:!0}))},[]);return o.jsx("div",{id:"results-container",children:a==null?void 0:a.map((e,r)=>{const i=e.cover_img&&y(e.cover_img),n=`img-${e.id}-${r}`;return o.jsx("div",{style:{padding:"16px 0",borderBottom:"1px solid #f0f0f0",transition:"background-color 0.15s ease"},children:o.jsxs("div",{className:"d-flex align-items-start gap-3",children:[i&&o.jsx("div",{style:{flexShrink:0},children:o.jsx(z,{src:"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7","data-src":`${"https://edatsu-media-storage.edatsu.com".replace(/\/$/,"")}/uploads/opp/${e.cover_img}`,"data-id":n,alt:`Cover image for ${e.title}`,className:"lazy-load",onError:g,onLoad:v(n),style:{width:"72px",height:"72px",objectFit:"cover",borderRadius:"12px",border:"1px solid #f0f0f0"}})}),o.jsxs("div",{className:"flex-grow-1",style:{minWidth:0},children:[o.jsxs("div",{className:"d-flex align-items-center gap-2 mb-1",children:[o.jsx("a",{target:"_blank",href:u("op",e.slug,e.id),style:{textDecoration:"none",color:"#000",fontSize:"14px",fontWeight:600,lineHeight:1.3,transition:"color 0.15s ease"},onMouseEnter:t=>t.currentTarget.style.color="#86868b",onMouseLeave:t=>t.currentTarget.style.color="#000",children:e.title}),e.is_trending&&o.jsx("span",{style:{display:"inline-flex",alignItems:"center",gap:"2px",padding:"2px 8px",borderRadius:"9999px",background:"#000",color:"#fff",fontSize:"10px",fontWeight:500,flexShrink:0},children:"Trending"})]}),e.continent_name&&o.jsx("div",{className:"mb-1",children:b(e.continent_name)}),o.jsx("p",{className:"d-none d-sm-block",style:{fontSize:"13px",color:"#86868b",lineHeight:1.5,margin:"4px 0"},children:A(e.description,150)}),o.jsxs("div",{className:"d-flex justify-content-between align-items-center mt-1",children:[o.jsx("span",{style:{fontSize:"12px",fontWeight:600,color:"#000"},children:C(e.deadline)}),o.jsxs("div",{className:"d-flex align-items-center gap-2",children:[o.jsxs("div",{className:"position-relative",children:[o.jsx("div",{className:"position-absolute share-panel d-none",style:{top:"auto",right:"0px",bottom:"35px",zIndex:1050,minWidth:"280px"}}),o.jsx("button",{className:"btn p-0","data-title":e.title,"data-id":e.id,onClick:t=>I(t.currentTarget),style:{border:"none",background:"transparent",cursor:"pointer"},children:o.jsx("span",{className:"material-symbols-outlined",style:{fontSize:"18px",color:"#86868b",transition:"color 0.15s ease"},onMouseEnter:t=>t.currentTarget.style.color="#000",onMouseLeave:t=>t.currentTarget.style.color="#86868b",children:"share"})})]}),o.jsx("button",{className:"btn p-0","data-id":e.id,"data-title":e.title,"data-type":"opp","data-url":u("op",e.id,e.slug),onClick:h,style:{border:"none",background:"transparent",cursor:"pointer"},children:o.jsx("span",{className:"material-symbols-outlined",style:{fontSize:"18px",fontVariationSettings:'"FILL" 1, "wght" 400, "GRAD" 0, "opsz" 24',color:e.is_bookmarked===1?"#f97316":"#86868b",transition:"color 0.15s ease"},onMouseEnter:t=>t.currentTarget.style.color="#f97316",onMouseLeave:t=>t.currentTarget.style.color=e.is_bookmarked===1?"#f97316":"#86868b",children:"bookmark"})})]})]})]})]})},`${e.id}-${r}`)})})};export{R as default};
