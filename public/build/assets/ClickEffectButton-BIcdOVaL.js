import{r as c,R as h,j as n}from"./app-BEqmn-IK.js";const x=({children:i,className:u="",variant:l="primary",size:o,disabled:r,loading:e=!1,type:d=null,onClick:s,...f})=>{const[a,m]=c.useState(!1),p=c.useCallback(t=>{r||e||a||(m(!0),s==null||s(t),setTimeout(()=>{m(!1)},200))},[r,e,a,s]),b=["btn",`btn-${l}`,o&&`btn-${o}`,a&&"btn-pressed",e&&"disabled",u].filter(Boolean).join(" ");return h.useEffect(()=>{const t=document.createElement("style");return t.innerHTML=`
      .btn-pressed {
